...
function modeltheme_shortcode_blogpost01($params, $content) {
    ...
    foreach ($blogposts as $blogpost) {
        ...
        #thumbnail
        $thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( $blogpost->ID ),'bitcurrency_news_shortcode_800x666' );
                        ...
                        <div class="blog_custom">
                          ...
                          <div class="title-n-excerpt">
                            ...
                            <div class="text-element content-element">
                              <p class="author">Post by <a href="'.get_author_posts_url($blogpost->ID).'">'.$display_name.'</a></p>
